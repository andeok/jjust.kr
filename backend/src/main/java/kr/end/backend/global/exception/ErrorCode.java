...
public enum ErrorCode {
  ...
  CURRENT_PASSWORD_MISMATCH(BAD_REQUEST, "현재 비밀번호가 일치하지 않습니다."),
  NEW_PASSWORD_MISMATCH(BAD_REQUEST, "새 비밀번호가 일치하지 않습니다."),
  NEW_CURRENT_PASSWORD_MISMATCH(BAD_REQUEST, "새 비밀번호가 현재 비밀번호와 같습니다."),
  ...
  SERVER_ERROR(INTERNAL_SERVER_ERROR, "예상치 못한 서버에러가 발생했습니다"),
